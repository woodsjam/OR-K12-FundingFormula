...
\title{Converting Oregon's K12 Funding Formula for More Equal Class Size and
Higher Aggregate Graduation Rates}
\shortTitle{Cost Sharing}
...
\author{
  James Woods\thanks{
  Woods: Portland State University, \href{mailto:woodsj@pdx.edu}{woodsj@pdx.edu}.
}
}
...
\pubIssue{1}
\JEL{A10, A11}
\Keywords{K12 Education, Cost Sharing Contracts}
